"""
Django settings for atp_38698 project.
...
WSGI_APPLICATION = 'atp_38698.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "atp_38698 API",
    "DESCRIPTION": "API documentation for atp_38698 App",
    "VERSION": "v1",
}
